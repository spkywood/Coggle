...
BASE_URL = '/Users/longfellow/Downloads/水利/'

file_name = '北京系列高分辨率卫星在永定河流域洪涝灾害分析中的应用_李双双.pdf'

fpath = os.path.join(BASE_URL, file_name)
"""
...
def column_boxes(page, footer_margin=0, header_margin=0, no_image_text=True):
...
if __name__ == "__main__":
    ...
    with fitz.open(fpath) as pdf_document:
        ...
        for i in range(len(pdf_document)):
            ...
            contexts.append(page_contexts)
    
    for i, context in enumerate(contexts):
        print(f"Page {i} \001 {context}")
        print("--------------\n")
